...
export const PLANS: PLAN[] = [
  {
    ...
    desc: "Perfect for solopreneurs and small teams starting their AI-powered marketing journey with essential automation tools.",
    monthlyPrice: 29,
    annuallyPrice: 290,
    buttonText: "Start Free Trial",
    features: [
      "AI content generation (1,000 words/mo)",
  ...
  },
  {
    id: "pro",
    title: "Scale Pro",
    desc: "Ideal for growing businesses and agencies who need advanced AI capabilities and automation to scale their marketing efforts.",
    monthlyPrice: 79,
    annuallyPrice: 790,
    badge: "Most Popular",
  ...
  //     id: "enterprise",
  //     title: "Enterprise AI",
  //     desc: "Complete AI marketing solution for large organizations requiring unlimited scale and custom AI implementations.",
  //     monthlyPrice: 199,
  //     annuallyPrice: 1990,
